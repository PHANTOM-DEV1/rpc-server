...
function startServer(port){
  if (program.allowRemote) console.log('Warning! phantom-rpc allows remote connections, this is potentially insecure!');
  ...
  server = restify.createServer().
    ...
    server.listen(port, function() {
      console.log('phantom-rpc listening at %s', server.url);
    });
}
